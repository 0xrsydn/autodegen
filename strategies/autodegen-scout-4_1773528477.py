"""
autodegen strategy — Acceleration Filter
"""
...
class Strategy:
    name = "accel_filter_v1"
    description = (
        "EMA 20/50 with HH+HL structure + acceleration filter. "
        "Enter only when momentum is accelerating (2nd derivative positive)."
    )
    parameters = {
        "ema_fast": 20,
        "ema_slow": 50,
    ...
    def on_bar(self, bar, portfolio):
        ...
        # Entry: EMA cross up with structure + positive acceleration
        if current_pos == 0:
