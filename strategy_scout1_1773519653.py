...
class Strategy:
    name = "ema_23_50_roc5_trail019"
    description = (
        "23/50 EMA cross with 5-bar ROC filter and 1.9% trailing stop. "
        "Slightly slower fast EMA (23 vs 22) with ROC filter for fewer false signals."
    )
    parameters = {
        "ema_fast": 23,
        "ema_slow": 50,
